...
$userFolders = @("Desktop", "Documents", "Downloads", "Favorites", "Pictures", "Videos")

foreach ($folder in $userFolders) {
    $backupSize += (Get-ChildItem $env:USERPROFILE\$folder -Recurse | Measure-Object Length -Sum).Sum
}
